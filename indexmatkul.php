    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <a href="<?php echo "formmatkul.php"; ?>" class="btn btn-primary">Tambah Data</a>
          <br>
          <br>
                ...
                <?php 
                 ...
                 <?php while($data = mysqli_fetch_array($result)): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo "updatematkul.php?kodematkul=".$data['kodematkul']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                      &nbsp;&nbsp;
                      <a href="<?php echo "delete.php?kodematkul=".$data['kodematkul']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                 <?php endwhile ?>
              </tbody>
